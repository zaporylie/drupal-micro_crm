...
/**
 * @file
 * Hooks provided by the CRM Contact module.
 */
 ...
 */
function hook_crm_contact_status_info() {
  $status = array();
 ...
 */
function hook_crm_contact_status_info_alter(&$statuses) {
  $statuses[CRM_CONTACT_STATUS_REGISTERED]['title'] = t('Unprocessed');
}
 ...
 * @see url()
 */
function hook_crm_contact_uri($contact) {
  // No example.
}
 ...
 */
function hook_crm_contact_presave($contact) {
  // No example.
}
 ...
 * @param $contact
 */
function hook_crm_contact_update($contact) {
  // No example.
}